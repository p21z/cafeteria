  ...
  <div class="card mb-4 w-75">
    ...
    <form method="post" action="<?= $form_location ?>">
      ...
      <div class="" style="">
        ...
        &nbsp;&nbsp;
        <a href="changepass.php?id=<?=$id?>" class="btn btn-warning btn-icon-split" style=" margin-top:3%; margin-bottom: 5%">
          <span class="icon text-white-50">
        ...
        &nbsp;&nbsp;
        <a href="home.php" class="btn btn-danger btn-icon-split" style=" margin-top:3%; margin-bottom: 5%">
          <span class="icon text-white-50">
